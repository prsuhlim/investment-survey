// src/components/survey/MidBreak.jsx
// Dedicated mid-break page (Progress bar/text are shown by SurveyShell)
  ...
  return (
    <main className="container">
      ...
      >
        ...
        <p>All other settings remain the same as before.</p>
        ...
        <p style={{ marginBottom: 0 }}>
          Take a moment to choose your answers carefully <br/>—{" "}
